...
representing the community in public spaces. Examples include using an official email address,
posting through an official social media account, or acting as an appointed representative at
an online or offline event.

## Enforcement

Report abusive, harassing, or otherwise unacceptable behavior privately to the project
maintainer using the [private reporting channel](docs/SECURITY.md#reporting). Prefix the report
title with `Code of Conduct`. Do not include sensitive conduct reports in a public issue.

All complaints will be reviewed promptly and fairly. Project maintainers must respect the
...
for a specified period. This includes avoiding interactions in community spaces as well as
